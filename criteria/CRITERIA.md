...
- `decision-risk-levels` [proposed] An automated decision may run unattended only at the risk level its recorded human-review agreement rate supports, and every automated decision must record its basis and confidence so that agreement can be measured at all.
